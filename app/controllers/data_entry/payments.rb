  ...
  class Payments < DataEntry::Controller
    ...
    def by_center
      ...
      unless @center.nil?
        ...
        @loans   = Loan.all(:id => LoanHistory.all(:center_id => @center.id).aggregate(:loan_id), :rejected_on => nil)
        ...
        @loans_to_disburse = @undisbursed_loans.all(:scheduled_disbursal_date.lte => @date)
