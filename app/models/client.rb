class Client
  ...
  property :marital_status,  Enum.send('[]', *MARITAL_STATUS), :required => false, :index => true
  ...
  property :family_1_gender, Enum.send('[]', *GENDER), :lazy => true, :required => false
  property :family_1_age, Integer, :lazy => true
  property :family_1_relationship, Enum.send('[]', *RELATIONSHIP), :lazy => true, :required => false
  property :family_1_marital_status,  Enum.send('[]', *MARITAL_STATUS), :lazy => true, :required => false
  ...
  property :family_2_gender, Enum.send('[]', *GENDER), :lazy => true, :required => false
  property :family_2_age, Integer, :lazy => true
  property :family_2_relationship, Enum.send('[]', *RELATIONSHIP), :lazy => true, :required => false
  property :family_2_marital_status,  Enum.send('[]', *MARITAL_STATUS), :lazy => true, :required => false
  ...
  property :family_3_gender, Enum.send('[]', *GENDER), :lazy => true, :required => false
  property :family_3_age, Integer, :lazy => true
  property :family_3_relationship, Enum.send('[]', *RELATIONSHIP), :lazy => true, :required => false
  property :family_3_marital_status,  Enum.send('[]', *MARITAL_STATUS), :lazy => true, :required => false
  ...
  property :family_4_gender, Enum.send('[]', *GENDER), :lazy => true, :required => false
  property :family_4_age, Integer, :lazy => true
  property :family_4_relationship, Enum.send('[]', *RELATIONSHIP), :lazy => true, :required => false
  property :family_4_marital_status,  Enum.send('[]', *MARITAL_STATUS), :lazy => true, :required => false
  ...
  property :vet_care_centre_distance, Integer, :required => false, :lazy => true
  ...
  property :insured_value, Integer, :required => false, :lazy => true
  property :insurer, String, :required => false, :lazy => true
  property :insurance_premium, Integer, :required => false, :lazy => true
  property :premium_payment_frequency, Enum.send('[]', *PREMIUM_PAYMENT_FREQUENCY), :lazy => true, :required => false
