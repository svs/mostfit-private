class Region
  ...
  validates_presence_of :manager, :message => I18n.t("region.error.validation.manager_not_present", :default => "Manager must not be blank")
  validates_uniqueness_of :name, :message =>  I18n.t("region.error.validation.name_not_unique", :default => "Name must be unique")
  max_name_length = 20
  min_name_length = 1
  validates_length_of :name, :max => max_name_length, :min => min_name_length, 
