...
namespace :mostfit do
  namespace :db do
    ...
    task :prepare do
      ...
      repository.adapter.execute("create index index_cachers_date_branch_id on cachers(date, branch_id);") rescue nil
      repository.adapter.execute("create index index_cachers_date_center_id on cachers(date, center_id);") rescue nil
